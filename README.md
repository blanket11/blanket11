<img src="./assets/hero.svg" width="100%" alt="HARU — Front-end Engineer / AI × Web × Product Development" />
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>Kokoiku</h3>
      <p>ライブやイベントの予定共有から、現場ログ・遠征・Cue連携までをまとめる推し活Webサービス。</p>
      <p><code>Next.js</code> <code>TypeScript</code> <code>Supabase</code></p>
      <a href="https://www.kokoiku.me/">kokoiku.me ↗</a>
    </td>
    <td width="50%" valign="top">
      <h3>HAZUMI</h3>
      <p>今の状態・活動・目標・時間から、作業や休息へ入るための音楽ルートをつくるWebアプリ。</p>
      <p><code>TypeScript</code> <code>Web Audio</code> <code>Cloudflare</code></p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>Kokoiku Cue</h3>
      <p>次のライブまでのカウントダウンと NOW LIVE、チェキ券管理を行う首掛けデバイス。</p>
      <p><code>M5Stack</code> <code>ESP32</code> <code>LVGL</code></p>
      <a href="https://github.com/blanket11/kokoiku-cue">Repository ↗</a>
    </td>
    <td width="50%" valign="top">
      <h3>DOG MOD</h3>
      <p>現実のDOGへスマホカメラを向け、3D形状を合わせて虹色のMOD演出を重ねるWeb作品。</p>
      <p><code>Three.js</code> <code>WebGL</code> <code>Computer Vision</code></p>
  ...
  <tr>
    <td colspan="2" valign="top">
      <h3>me.push.tokyo</h3>
      <p>勉強会やイベントでそのままデジタル名刺として使える、作品・SNSへの入口をまとめた個人Web。</p>
      <p><code>Next.js</code> <code>TypeScript</code> <code>Cloudflare Pages</code></p>
